...
const PutTheaterForm = ({theatermovie}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (movie) {
            axios.put(`http://localhost:4000/categories/theater/${theatermovie._id}`, movie).then((Response) => {
        ...
        <>
            <form className="row g-2 was-validated">
                <div className="col-md-4">
                    ...
                    <input ref={movie_name} defaultValue={theatermovie.movie_name} type="text" className="form-control is-valid" id="validationServer01" required />
                </div>
                <div className="col-md-4">
                    <label htmlFor="validationServer02" className="form-label">عنوان:</label>
                    <input ref={title} defaultValue={theatermovie.title} type="text" className="form-control is-valid" id="validationServer02" required />
                </div>
                <div className="col-md-4">
                    <label htmlFor="validationServer02" className="form-label">بازیگران:</label>
                    <input ref={actors} defaultValue={theatermovie.actors} type="text" className="form-control is-valid" id="validationServer02" required />
                </div>
                <div className="col-md-4">
                    <label htmlFor="validationServer02" className="form-label">کارگردان:</label>
                    <input ref={director} defaultValue={theatermovie.director} type="text" className="form-control is-valid" id="validationServer02" required />
                </div>
                <div className="col-md-4">
                    <label htmlFor="validationServer02" className="form-label">تهیه کننده:</label>
                    <input ref={producer} defaultValue={theatermovie.producer} type="text" className="form-control is-valid" id="validationServer02" required />
                </div>
                <div className="col-md-4">
                    <label htmlFor="validationServer02" className="form-label">تاریخ تولید:</label>
                    <input ref={production_date} defaultValue={theatermovie.production_date} type="text" id="validationServer02" className="form-control is-valid" required />
                </div>
                <div className="col-md-4">
                    <label htmlFor="validationServer02" className="form-label">تاریخ اکران:</label>
                    <input ref={release_date} defaultValue={theatermovie.release_date} type="text" className="form-control is-valid" id="validationServer02" required />

                </div>
                <div className="col-md-4">
                    <label htmlFor="validationTextarea" className="form-label">توضیحات و خلاصه فیلم:</label>
                    <textarea ref={description} defaultValue={theatermovie.description}  className="form-control is-invalid" id="validationTextarea" placeholder="خلاصه ایی از فیلم را ذکر کنید ..." required></textarea>
                </div>
                ...
                <div className="mb-3">
                    ...
                    <button onClick={handleRefresh} className="btn btn-danger" type="submit" >بازگشت به فرم تئاتر</button>
                </div>
            </form>
        </>
    )
